...
function HowItWorks({ onNavigate }) {
	return (
		<div className="how-page">
			...
			<div className="pro-ticker-wrap" aria-label="Mazdoor Sytu highlights" aria-hidden="true">
				<div className="pro-ticker-track">
					{[0, 1].map((g) => (
						<div className="pro-ticker-group" key={g}>
						<span className="ticker-brand">Mazdoor Sytu</span>
						<span className="ticker-dot">✦</span>
						<span><span className="ticker-icon">⚡</span>Instant Booking</span>
						<span className="ticker-dot">✦</span>
						<span><span className="ticker-icon">🔒</span>Aadhaar Verified</span>
						<span className="ticker-dot">✦</span>
						<span className="ticker-brand">Mazdoor Sytu</span>
						<span className="ticker-dot">✦</span>
						<span><span className="ticker-icon">📍</span>Hyperlocal Matching</span>
						<span className="ticker-dot">✦</span>
						<span><span className="ticker-icon">⭐</span>Rated Tradesmen</span>
						<span className="ticker-dot">✦</span>
						<span className="ticker-brand">Mazdoor Sytu</span>
						<span className="ticker-dot">✦</span>
						<span><span className="ticker-icon">💳</span>UPI &amp; Cash Payments</span>
						<span className="ticker-dot">✦</span>
						<span><span className="ticker-icon">🛡️</span>Trusted Platform</span>
						<span className="ticker-dot">✦</span>
						<span className="ticker-brand">Mazdoor Sytu</span>
						<span className="ticker-dot">✦</span>
						<span><span className="ticker-icon">🏗️</span>Skilled Workforce</span>
						<span className="ticker-dot">✦</span>
						<span><span className="ticker-icon">🚀</span>15-Min Dispatch</span>
						<span className="ticker-dot">✦</span>
						<span className="ticker-brand">Mazdoor Sytu</span>
						<span className="ticker-dot">✦</span>
						<span><span className="ticker-icon">🤝</span>Direct Worker Connect</span>
						<span className="ticker-dot">✦</span>
						<span><span className="ticker-icon">📞</span>24 / 7 Support</span>
						<span className="ticker-dot">✦</span>
					</div>
					))}
				</div>
