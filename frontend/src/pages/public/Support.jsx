...
const FAQS_DATA = [
  {
    ...
    a: 'You can directly call the worker from your booking screen. If they do not respond or are delayed by more than 15 minutes, select "Request a replacement worker" or message our WhatsApp helpline at +91 8004264176 to have an alternate verified technician assigned.',
  },
  {
    id: 'f2',
    category: 'worker',
    q: 'How do workers receive their daily wage payment?',
    a: 'Payment is made directly between you and the customer or contractor (via Cash or UPI). Payments are processed transparently with same-day settlements.',
  },
  {
    id: 'f3',
    category: 'customer',
  ...
  },
  {
    ...
    a: 'Yes. You can post a project requirement under the Jobs portal or message our WhatsApp helpline (+91 8004264176) with the number of masons, helpers, electricians, welders, or painters required for your site.',
  },
  {
    id: 'f5',
    category: 'customer',
      ...
      <section className="support-channels-section" aria-label="Contact Channels">
        ...
        <div className="channels-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))' }}>
          ...
          <div className="channel-card highlight-tollfree">
            ...
            <a href="tel:+918004264176" className="channel-action-btn btn-green-solid">
              <span>Call +91 8004264176</span>
              <span>↗</span>
            </a>
          </div>
          ...
          <div className="channel-card">
            ...
            <a
              href={`https://wa.me/918004264176?text=${encodeURIComponent(`Hello Mazdoor Sytu Support, I need assistance.`)}`}
              target="_blank"
              rel="noreferrer"
          ...
          <div className="channel-card">
            ...
            <a href="mailto:mazdoorsetu.support@gmail.com" className="channel-action-btn">
              <span>mazdoorsetu.support@gmail.com</span>
              <span>↗</span>
            </a>
          </div>
        </div>
      ...
      <section className="support-ticket-container" id="ticket-form-section" aria-label="Support Form">
        ...
        <div className="ticket-form-side">
          ...
          {submittedTicket ? (
            <div className="ticket-success-card">
              ...
              <a
                href={`https://wa.me/918004264176?text=${encodeURIComponent(`Hello Mazdoor Sytu Support, I created reference ID ${submittedTicket.id} regarding "${submittedTicket.category}". My name is ${submittedTicket.name} (${submittedTicket.phone}).`)}`}
                target="_blank"
                rel="noreferrer"
        ...
        <div className="ticket-info-side">
          ...
          <div style={{ background: '#ecfdf5', border: '1px solid #a7f3d0', borderRadius: '12px', padding: '14px 16px', fontSize: '12.5px', color: '#065f46', lineHeight: 1.5 }}>
            🛡️ <strong>Direct &amp; Safe:</strong> You can always call our helpline at <strong>+91 8004264176</strong> or WhatsApp us directly at <strong>+91 8004264176</strong> if you prefer not to fill the form.
          </div>
        </div>
      </section>
      ...
      <section className="support-charter-section" aria-label="Trust Promises">
        ...
        <div className="charter-grid">
          <div className="charter-pillar-card">
            ...
            <p>Customers and contractors pay workers directly. Transparent terms and same-day settlements to your account.</p>
          </div>
