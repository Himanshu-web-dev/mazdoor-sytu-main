...
export default function Profile({ session, onNavigate, onProfileUpdate, onLogout }) {
  ...
  const [phone, setPhone] = useState(store.profile?.phone || '+91 98765 43210')
  const [email, setEmail] = useState(store.profile?.email || 'riya.kapoor@example.com')
  ...
  const [emergencyPhone, setEmergencyPhone] = useState(store.profile?.emergencyContact?.phone || '+91 98111 22233')
