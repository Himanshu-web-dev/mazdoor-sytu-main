...
const SIGNUP_ROLE_INFO = {
  customer: {
    ...
    stats: [
      ...
      { label: 'Booking Fee', value: '₹0 Free' },
  ...
  worker: {
    ...
    description: 'Receive direct customer service requests on your phone, daily instant UPI bank settlements, and zero commission on your first 20 orders.',
    stats: [
      { label: 'Commission', value: '0% First 20' },
