    ...
    if (updatedProfile?.name) {
      setWorkerData((current) => ({
        ...
        profile: {
          ...
          phone: updatedProfile.phone || current.profile.phone,
          email: updatedProfile.email || current.profile.email,
          service: updatedProfile.service || current.profile.service,
          experience: updatedProfile.experience || current.profile.experience,
          serviceArea: updatedProfile.serviceArea || current.profile.serviceArea,
          pricing: updatedProfile.pricing || current.profile.pricing,
          verification: updatedProfile.verification || current.profile.verification,
        },
      }))
    }
  }
